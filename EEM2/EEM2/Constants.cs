...
public class Constants
{
    ...
    public static string FighterDebugPrefix = @"fighter.";
    public string BotDebugPrefix = @"botBase.";
    public string FreighterDebugPrefix = @"freighter.";
        
    // CleanUp.cs's constants:

    // verbose debug log output
    public const bool CleanupDebug = true;
